    ...
    <div ref={pageRef} className="min-h-screen bg-black">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          <Card className="analysis-card hover-lift art-deco-card bg-black/80 border-yellow-500/30 backdrop-blur-sm group">
            <CardHeader>
            ...
            <CardContent>
              ...
              <div className="mt-4 p-4 bg-yellow-500/10 rounded-md border border-yellow-500/20 group-hover:bg-yellow-500/20 transition-colors">
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="border-l-4 border-yellow-400 pl-4 group-hover:border-yellow-300 transition-colors">
                  ...
                  <p className="text-gray-300">Represents Gatsby's hopes and dreams - both Daisy and the American Dream</p>
                </div>
                <div className="border-l-4 border-yellow-400 pl-4 group-hover:border-yellow-300 transition-colors">
                  <h4 className="font-semibold text-yellow-300">The Valley of Ashes</h4>
                  <p className="text-gray-300">A wasteland between wealthy areas that represents moral and social decay</p>
                </div>
                <div className="border-l-4 border-yellow-400 pl-4 group-hover:border-yellow-300 transition-colors">
                  <h4 className="font-semibold text-yellow-300">The Eyes of Dr. T.J. Eckleburg</h4>
                  <p className="text-gray-300">Billboard eyes that watch over the Valley of Ashes like God watching a morally empty world</p>
                </div>
                <div className="border-l-4 border-yellow-400 pl-4 group-hover:border-yellow-300 transition-colors">
                  <h4 className="font-semibold text-yellow-300">Weather</h4>
                  <p className="text-gray-300">Heat during tense scenes, rain during emotional moments - the weather matches the mood</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="analysis-card hover-lift mb-12 art-deco-card bg-black/80 border-yellow-500/30 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-yellow-400 font-[Playfair_Display]">
        ...
        <Card className="analysis-card hover-lift art-deco-card bg-black/80 border-yellow-500/30 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-yellow-400 font-[Playfair_Display]">
          ...
          <CardContent>
            ...
            <div className="mt-6 p-5 bg-yellow-500/10 rounded-lg border border-yellow-500/20">
